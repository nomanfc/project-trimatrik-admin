...
import { CadreColumnData } from "../../../components/TableColumns/ColumnData";
...
const CadreTypeTable = (props) => {
  const [tableData, setTableData] = useState([""]);

  useEffect(() => {
    props.cadre ? setTableData(props.cadre) : setTableData(defaultValue);
  }, [props]);

  const detailsHandler = (data) => () => {};

  const headerColumn = useMemo(() => CadreColumnData, []);
  ...
  return (
    <>
      ...
      >
        ...
        <div>
          <Tooltip title="Add Cadre Type" aria-label="add">
            <IconButton onClick={props.handleAddCadreModal}>
                  ...
                  <s.td>
                    <s.actionCon>
                      <Tooltip title="Edit" aria-label="Edit">
                        <IconButton
                          onClick={props.handleOpenEditCadreModal({ row })}
                        >
                      ...
                      <Tooltip title="Remove" aria-label="remove">
                        <IconButton
                          onClick={props.handleOpenRemoveCadreModal({ row })}
                        >
