      ...
      >
        ...
        <div>
          <Tooltip title="Create new" aria-label="create">
            <IconButton
              onClick={() => Router.push("/memberpayable/addpayable")}
            >
                  ...
                  <s.td>
                    <s.actionCon>
                      {row.original.is_active === 1 ? (
                        ...
                        >
                          <IconButton
                            onClick={props.handleOpenDisApproveModal({ row })}
                          >
                        ...
                        >
                          <IconButton
                            onClick={props.handleOpenApproveModal({ row })}
                          >
                            <CheckCircleIcon
                      ...
                      >
                        <IconButton
                          onClick={props.handleOpenDetailsModal({ row })}
                        >
